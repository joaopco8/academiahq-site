    ...
    return (
      <>
        <div
          ...
          style={{ aspectRatio }}
          onClick={() => externalHref ? window.open(externalHref, "_blank", "noopener,noreferrer") : setIsModalOpen(true)}
          onKeyDown={(e) => e.key === "Enter" && (externalHref ? window.open(externalHref, "_blank", "noopener,noreferrer") : setIsModalOpen(true))}
          tabIndex={0}
