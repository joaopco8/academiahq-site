        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/ativacoes" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Ativações
                </Link>
              </li>
              <li>
                <Link href="/atendimentos" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Atendimentos
                </Link>
              </li>
              <li>
                <Link href="/loja" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Loja
                </Link>
              </li>
              <li>
                <Link href="/agenda" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Agenda
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://t.me/+ahvSiX8l_5JkMzQx" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
