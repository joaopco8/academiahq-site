...
export default function DjhonRhuoPage() {
  ...
  return (
    <main className="flex flex-col items-center overflow-hidden" style={{ background: "#030712" }}>
      ...
      <section className="w-full py-24 px-4" style={{ background: "#030712" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed mb-6" style={{ color: "#94a3b8" }}>
            A ativação é realizada <span style={{ color: "#f8fafc" }}>online, ao vivo com Sergio Oliveira</span>,
            de forma individual e direcionada para o seu momento consciencial específico.
          </p>
          <p className="text-lg leading-relaxed mb-6" style={{ color: "#94a3b8" }}>
          ...
          <p className="text-lg leading-relaxed" style={{ color: "#94a3b8" }}>
            Após a sessão, o processo de integração segue de forma progressiva —
            podendo levar <span style={{ color: "#d4af37" }}>até 16 dias para estar completamente ativado</span> em você,
            respeitando o tempo natural de cada estrutura consciencial.
          </p>
      ...
      {/* ── INVESTIMENTO ── */}
      <section className="w-full py-24 px-4" style={{ background: "#030712", borderTop: "1px solid #d4af3715" }}>
        <div className="max-w-2xl mx-auto text-center">
          <span className="text-xs font-mono tracking-widest uppercase mb-4 block" style={{ color: "#d4af37" }}>— Investimento —</span>
          <h2 className="text-3xl md:text-4xl font-bold mb-12" style={{ color: "#f8fafc" }}>
            Acesso à Ativação
          </h2>

          <div className="relative rounded-sm overflow-hidden" style={{
            background: "linear-gradient(135deg, #0a1a0e 0%, #060d08 100%)",
            ...
            <div className="p-10">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 mb-8 px-3 py-1 rounded-full text-xs font-mono tracking-widest uppercase" style={{ background: "#10b98112", border: "1px solid #10b98130", color: "#10b981" }}>
              ...
              {/* Price */}
              <div className="mb-2">
                <span className="text-sm font-mono" style={{ color: "#64748b" }}>Investimento</span>
              </div>
              <div className="flex items-end justify-center gap-2 mb-2">
                <span className="text-2xl font-light" style={{ color: "#94a3b8" }}>R$</span>
                ...
                <span className="text-2xl font-light mb-2" style={{ color: "#94a3b8" }}>,00</span>
              </div>

              {/* Parcelamento */}
              <p className="text-base mb-8" style={{ color: "#64748b" }}>
                ou em até{" "}
                <span className="font-bold" style={{ color: "#d4af37" }}>12x</span>
                {" "}no cartão
              </p>

              {/* Divider */}
              <div className="flex items-center gap-4 mb-8">
                <div className="h-px flex-1" style={{ background: "#d4af3720" }} />
                <div className="w-1.5 h-1.5 rotate-45" style={{ background: "#d4af3750" }} />
                <div className="h-px flex-1" style={{ background: "#d4af3720" }} />
              </div>
                ...
                {[
                  {
                    icon: (
                      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5 flex-shrink-0 mt-0.5">
                        <circle cx="10" cy="10" r="8" stroke="#10b981" strokeWidth="1.2" />
                  ...
                  },
                  {
                    icon: (
                      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5 flex-shrink-0 mt-0.5">
                        <circle cx="10" cy="10" r="8" stroke="#10b981" strokeWidth="1.2" />
                        <path d="M10 6v4" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" />
                        <circle cx="10" cy="13.5" r="0.8" fill="#10b981" />
                      </svg>
                    ),
                    label: "Condução",
                    value: "Sergio Oliveira",
                  },
                ].map((detail) => (
                  <div key={detail.label} className="flex items-start gap-3 p-3 rounded-sm" style={{ background: "#10b98108", border: "1px solid #10b98115" }}>
                    {detail.icon}
                    <div>
                      <p className="text-xs font-mono uppercase tracking-wider mb-0.5" style={{ color: "#64748b" }}>{detail.label}</p>
                      <p className="text-sm font-medium" style={{ color: "#f8fafc" }}>{detail.value}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-3 font-bold uppercase tracking-widest px-10 py-4 rounded-sm transition-all duration-300 hover:scale-[1.02]"
                style={{
                  background: "linear-gradient(135deg, #d4af37, #a07d1c)",
                  color: "#030712",
                  fontSize: "0.85rem",
              ...
              >
                ...
                Quero Acessar — Entre em Contato
              </a>
