      ...
      <section className="relative w-full sec-pad overflow-hidden text-center"
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <div className="reveal">
            ...
            <p className="mb-8 mx-auto" style={{ maxWidth:560, color:P.textMuted, lineHeight:1.85, fontWeight:300, fontSize:"clamp(.9rem,1.4vw,1rem)" }}>
            ...
            <a href={WA_AULA} target="_blank" rel="noopener noreferrer" className="reveal mx-auto block"
              ...
              <div style={{ position:"relative", width:"100%", paddingTop:"56.25%" /* 16:9 */ }}>
                ...
                <div style={{ position:"absolute", top:14, right:14, background:"#FF0000", borderRadius:6, padding:"4px 8px", display:"flex", alignItems:"center", gap:5 }}>
                  ...
                  <span style={{ color:"white", fontSize:".65rem", fontWeight:700, letterSpacing:".06em" }}>YouTube</span>
                </div>
                {/* play button */}
                <div style={{ position:"absolute", inset:0, display:"flex", alignItems:"center", justifyContent:"center" }}>
                  <div style={{ width:72, height:72, borderRadius:"50%", background:"rgba(0,0,0,0.72)", border:"2px solid rgba(255,255,255,0.25)", display:"flex", alignItems:"center", justifyContent:"center", backdropFilter:"blur(4px)" }}>
